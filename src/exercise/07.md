...
Use unique identifier instead of an index for key prop values when rendering an array of elements.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=amontrezor%40deloitte.ca).
