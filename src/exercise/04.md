...
I've ennjoyed getting to know powers of JSX closely. It's really a powerful tool.
...
We could either write our own type checker like
const PropTypes = {
  string(props, propName, componentName) {
    if (typeof props[propName] !== 'string') {
      return new Error(`A prop must be a string for ${componentName} component`)
    }
  },
}

or to use prop-types library to use preset PropTypes
<script src="https://unpkg.com/prop-types@15.7.2/prop-types.js"></script>

PropTypes is just a development feature, babel will remove this feature in production
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=amontrezor%40deloitte.ca).
