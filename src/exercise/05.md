...
It's good to find out that you have to pass object to style prop to apply inline styles.

Also, knowing that props with the same keys ({backgroundColor: green;}) like styles or classNames could override each other. So I should keep that in mind.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=amontrezor%40deloitte.ca).
